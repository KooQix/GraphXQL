...
public class DataFileReader12<D> implements FileReader<D>, Closeable {
	...
	private DataFileReader2.SeekableInputStream in;
	...
	public DataFileReader12(SeekableByteArrayInput sin, DatumReader<D> reader) throws IOException {
		this.in = new DataFileReader2.SeekableInputStream(sin);
