 ...
 * {@link #addCodec(String, CodecFactory2)}.
 */
public abstract class CodecFactory2 {
	private static final Logger LOG = LoggerFactory.getLogger(CodecFactory2.class);

	/** Null codec, for no compression. */
	public static CodecFactory2 nullCodec() {
	 ...
	 * 1 and 9, inclusive.
	 */
	public static CodecFactory2 deflateCodec(int compressionLevel) {
	 ...
	 * 9, inclusive.
	 */
	public static CodecFactory2 xzCodec(int compressionLevel) {
		return new XZCodec.Option(compressionLevel);
	}

	/** Snappy codec. */
	public static CodecFactory2 snappyCodec() {
		try {
	...
	/** bzip2 codec. */
	public static CodecFactory2 bzip2Codec() {
	 ...
	 *              use a lot of memory.
	 */
	public static CodecFactory2 zstandardCodec(int level) {
	 ...
	 */
	public static CodecFactory2 zstandardCodec(int level, boolean useChecksum) {
	 ...
	 */
	public static CodecFactory2 zstandardCodec(int level, boolean useChecksum, boolean useBufferPool) {
	 ...
	 */
	private static final Map<String, CodecFactory2> REGISTERED = new HashMap<>();
	 ...
	 * </ul>
	 */
	public static CodecFactory2 fromString(String s) {
		CodecFactory2 o = REGISTERED.get(s);
		if (o == null) {
	 ...
	 */
	public static CodecFactory2 addCodec(String name, CodecFactory2 c) {
		if (c != null) {
